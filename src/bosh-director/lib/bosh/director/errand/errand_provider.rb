module Bosh::Director
  class Errand::ErrandProvider
    ...
    def get(deployment_name, errand_name)
      ...
      event_log_stage.advance_and_track('Preparing deployment') do
        ...
        if errand_instance_group.is_errand?
          ...
          needed_instance_plans = needed_instance_plans(errand_instance_group, template_blob_cache)
    ...
    def needed_instance_plans(errand_instance_group, template_blob_cache)
      needed_instance_plans = errand_instance_group.needed_instance_plans
      JobRenderer.render_job_instances_with_cache(needed_instance_plans, template_blob_cache, @logger)
