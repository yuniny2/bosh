module Bosh::Director
  module Jobs
    class UpdateDeployment < BaseJob
      ...
      def perform
        ...
        with_deployment_lock(@deployment_name) do
          ...
          begin
            ...
            if is_deploy_action
              update_instance_plans_variable_set_id(deployment_plan.instance_groups, current_variable_set)
            end
      ...
      private
      def update_instance_plans_variable_set_id(instance_groups, current_variable_set)
      ...
      def remove_unused_variable_sets(deployment, instance_groups)
        ...
        referenced_variable_sets = []
        referenced_variable_sets << current_variable_set
        instance_groups.each do |instance_group|
          referenced_variable_sets << instance_group.referenced_variable_sets
        end

        unreferenced_variable_sets = 
      end
