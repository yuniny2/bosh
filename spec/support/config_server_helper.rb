...
module Bosh::Spec
  class ConfigServerHelper
    def initialize(sandbox)
      ...
      @config_hash = {
          'uaa_client_id' => sandbox.director_config.config_server_uaa_client_id,
          'uaa_client_secret' => sandbox.director_config.config_server_uaa_client_secret,
          'uaa_url' => sandbox.director_config.config_server_uaa_url,
          'uaa_ca_cert_path' => sandbox.director_config.config_server_uaa_ca_cert_path
      }
    end
    ...
    def put_value(key, value)
      ...
      auth_provider = Bosh::Director::UAAAuthProvider.new(@config_hash, logger)
