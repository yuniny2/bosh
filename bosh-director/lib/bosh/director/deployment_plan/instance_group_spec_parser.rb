  ...
  module DeploymentPlan
    class InstanceGroupSpecParser
      ...
      def parse_disks
        ...
        persistent_disk_collection = PersistentDiskCollection.new(multiple_disks: false)
        ...
        if persistent_disks
          persistent_disk_collection = PersistentDiskCollection.new(multiple_disks: true)
